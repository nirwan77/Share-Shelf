          ...
          <div className="flex items-center flex-1 max-w-md mx-8">
            <div className="relative w-full group">
              <input
                ...
                className="w-full bg-gray-800 text-white text-sm rounded-full py-1.5 pl-10 pr-4 focus:outline-none focus:ring-1 focus:ring-orange-500/50 transition-all border border-transparent focus:border-orange-500/50"
                onKeyDown={(e) => {
                  if (e.key === "Enter") {
                    router.push(`/user?search=${e.currentTarget.value}`);
                  }
                }}
              />
