...
import { useGetPostData } from "./action";
...
export default function SocialFeed() {
  ...
  const tabs = [
    { id: "newest", label: "Newest and Recent", sub: "Find the latest posts" },
    {
      ...
      sub: "Chec featured today by craters",
    },
    {
      id: "following",
      label: "Following",
      badge: 89,
      sub: "Follow from your favourite persons",
    },
  ];
  ...
  return (
    <div className="flex pt-16 min-h-screen bg-[#1a1a1a] text-[#e0e0e0]">
      ...
      {data && (
        <main className="flex-1 px-6 py-5">
          ...
          <div className="flex items-center gap-3 bg-[#2a2a2a] rounded-xl px-4 py-2.5 mb-5 border border-[#333]">
            ...
            />
            <button className="bg-[#e8630a] text-white border-none rounded-lg px-[18px] py-2 font-semibold text-[13px] cursor-pointer whitespace-nowrap">
              Create Post
            </button>
          </div>
          ...
          {!isLoading && !isError && (
            <div className="flex flex-col gap-3.5">
              {data?.map((post, index) => {
                const postId = post.createdByUser?.id ?? String(index);
                return (
                  <div
                    key={postId}
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {/* Likes / Comments / Heart */}
                        <div className="flex items-center gap-4 text-[12px] text-[#888]">
                          <span>
                            {(post._count?.reactions ?? 0).toLocaleString()}{" "}
                            Likes
                          </span>
